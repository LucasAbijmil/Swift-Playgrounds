import SwiftUI
/*:
 # Swift peut désormais trouver des membres conformes à un même protocol dans une fonction générique
 * Use principalement avec SwiftUI (notamment pour les *Whatever*`Style`)
